...
import dev.haqim.simplevideocourseapp.data.mechanism.CustomThrowable

@OptIn(ExperimentalPagingApi::class)
abstract class BaseRemoteMediator<EntityType: Any>: RemoteMediator<Int, EntityType>(){
    override suspend fun load(
        ...
        val result = try {
            ...
            if (
                (e.code == CustomThrowable.UNKNOWN_HOST_EXCEPTION) ||
